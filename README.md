<div align="center">
  ...
  <p>
    <a href="VERSION.md"><img src="https://img.shields.io/badge/version-v1.2.2-f2a65a?style=flat-square" alt="版本 v1.2.2" /></a>
...
当前声明版本为 **v1.2.2**。完整的支持范围、已知限制和语义化版本规则见 [VERSION.md](VERSION.md)。
